...
const buildMenu = (prefix, botName, uptime, ram, ping, mode, name, cmdCount, plan, isOwner, senderNumber) => {
  ...
  const menu = [
    ...
    // ── Gaming Profiles
    section('GAMING PROFILES', ['minecraft','xbox','steam','roblox','psn','fortnite','valorant','chess','github'], prefix),

    // ── GitHub
    section('GITHUB', ['downloadrepo'], prefix),

    // ── OSINT / Lookup
    section('OSINT / LOOKUP', ['ipinfo','emailcheck','phonelookup','usercheck'], prefix),

    // ── Gaming (game commands)
    ...
    // ── Tools (extra)
    section('TOOLS', ['tts','vv','vv2','save','meme','roastme','naija','tempmail','tempmail-inbox','url','qrcode','screenshot','carbon','obfuscate','sandbox','readmore','emojimix','sendstatus'], prefix),
